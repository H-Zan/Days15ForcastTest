package com.admai.days15forcasttest.hours;
...
//                                  ); 
                ...
                drawTemp.setBounds(
                    getScrollBarX()+DisplayUtil.dip2px(getContext(), 7)+ITEM_WIDTH/2 , //变小右移
                    Y - DisplayUtil.dip2px(getContext(), 28),  //上
                    getScrollBarX()+ITEM_WIDTH ,  //变小左移
                    Y - DisplayUtil.dip2px(getContext(), 10)    //下
                                  );
